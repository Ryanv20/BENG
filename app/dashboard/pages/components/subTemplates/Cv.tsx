  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-black rounded-lg shadow-md mt-8 text-white max-h-[90vh] overflow-y-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <input name="email" value={formData.email} onChange={handleChange} type="email" placeholder="Email" className={inputClass}/>
        ...
        <input name="skills" value={formData.skills} onChange={handleChange} type="text" placeholder="Skills (comma separated)" className={inputClass}/>
        ...
        <textarea name="certifications" value={formData.certifications} onChange={handleChange} placeholder="Certifications (comma separated)" className={inputClass}/>
